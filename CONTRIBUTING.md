...
- Raise an issue found via [GitHub Issues](https://github.com/Arm-Examples/verify-cmsis-example-action/issues).
- Open an [pull request](https://github.com/Arm-Examples/verify-cmsis-example-action/pulls) to:
  - Provide a fix.
